...
- JavaScript — Node.js 20 LTS (backend), React 18 via Next.js 14 (frontend) (004-skill-tree)
...
## Recent Changes
- 004-skill-tree: Added JavaScript — Node.js 20 LTS (backend), React 18 via Next.js 14 (frontend)
