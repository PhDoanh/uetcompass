...
- JavaScript (Node.js 20 LTS backend, React 18 + Vite frontend) + Express, Mongoose, JWT auth middleware, React Query/HTTP service layer (existing frontend services) (010-roadmap-community)
- MongoDB Atlas (existing monolithic backend DB) (010-roadmap-community)
...
## Recent Changes
- 010-roadmap-community: Added JavaScript (Node.js 20 LTS backend, React 18 + Vite frontend) + Express, Mongoose, JWT auth middleware, React Query/HTTP service layer (existing frontend services)
