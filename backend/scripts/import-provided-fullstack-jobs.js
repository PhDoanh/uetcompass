...
const ROLE_CODE = 'fullstack';
const ROLE_LABEL = 'Fullstack';
const EXTRA_FULLSTACK_URL = 'https://www.topcv.vn/viec-lam/software-engineer-golang-python-java/2172576.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780189066';

const URLS = [
    'https://www.topcv.vn/viec-lam/developer/2134764.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150402',
    'https://www.topcv.vn/viec-lam/full-stack-developer-tu-1-nam-kinh-nghiem/2173814.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150402',
    'https://www.topcv.vn/viec-lam/nhan-vien-it-phan-mem-software-developer-nghi-t7-cn/2179609.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150402',
    'https://www.topcv.vn/viec-lam/fullstack-developer-reactjs-nodejs/2161486.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150402',
    'https://www.topcv.vn/viec-lam/lap-trinh-vien-nhan-vien-dev/1502362.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150402',
    'https://www.topcv.vn/viec-lam/lap-trinh-vien-net/1594132.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150402',
    'https://www.topcv.vn/viec-lam/lap-trinh-vien-web-c-net-tu-2-nam-kinh-nghiem/2151799.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150545',
    'https://www.topcv.vn/viec-lam/web-developer-backend-frontend-2-nam-kinh-nghiem-luong-tu-18-25-trieu-thang-15-thang-luong-nam/2169853.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150545',
    'https://www.topcv.vn/viec-lam/lap-trinh-fullstack-ha-noi-thu-nhap-upto-23-trieu-tu-2-nam-kinh-nghiem/2106213.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150545',
    'https://www.topcv.vn/viec-lam/web-developer-backend-frontend-2-nam-kinh-nghiem-luong-tu-18-25-trieu-thang-15-thang-luong-nam/2169853.html?ta_source=JobSearchList_ButtonApplyFormCard&u_sr_id=QXf1VQiBgFvFYC6BS2umUjBuB9X0VIdSZl9gQmi7_1780150545',
    EXTRA_FULLSTACK_URL,
];
...
function inferSkills(text) {
    ...
    return ['Fullstack', 'Full Stack', 'Frontend', 'Backend', 'ReactJS', 'NodeJS', 'JavaScript', 'TypeScript', '.NET', 'C#', 'PHP', 'SQL']
...
async function extractTopcvJob(browser, inputUrl) {
    ...
    return {
        ...
        roleCodes: [ROLE_CODE],
        crawlQuery: 'provided_fullstack_url',
        title: jobTitle,
        companyName,
        ...
        jobExpertise: 'Fullstack Developer',
        description,
        requirements,
        benefits,
...
async function main() {
    ...
    const seen = new Set();
    const urlsToCrawl = process.argv.includes('--only-extra') ? [EXTRA_FULLSTACK_URL] : URLS;
